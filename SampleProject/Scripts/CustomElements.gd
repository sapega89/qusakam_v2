...
func draw_elevator(canvas_item: RID, coords: Vector3i, pos: Vector2, size: Vector2, _data: String):
...
func draw_label(canvas_item: RID, coords: Vector3i, pos: Vector2, _size: Vector2, data: String):
