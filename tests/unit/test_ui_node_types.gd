...
func test_coin_icon_type_matches_script():
	...
	var expected_type = ColorRect  # Should be ColorRect
	assert_true(coin_icon is expected_type,
		"CoinIcon type mismatch: expected %s, got %s" % [expected_type, coin_icon.get_class()])
